        ...
        <div className="prose prose-gray max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              By accessing or using the Document Management System (DMS), you agree to be bound by
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-muted-foreground">
              Permission is granted to temporarily access and use the DMS service for personal or
              business document management purposes, subject to the following restrictions:
            </p>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              <li>
                You may not attempt to decompile or reverse engineer any software contained in DMS
              </li>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold">4. Data and Content</h2>
            <p className="mb-4 text-muted-foreground">
              You retain all rights to the documents and content you upload to DMS. By uploading
              content, you grant us a limited license to store, process, and transmit your content
              solely for the purpose of providing the service. We will not:
            </p>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <li>
                Access your documents except as necessary to provide support or comply with legal
                requirements
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              We strive to maintain 99.9% uptime for DMS. However, we do not guarantee uninterrupted
              access and may temporarily suspend the service for maintenance, updates, or due to
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              DMS and its suppliers shall not be liable for any damages arising from the use or
              inability to use the service, including but not limited to direct, indirect,
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              significant changes via email or through the service. Continued use of DMS after
